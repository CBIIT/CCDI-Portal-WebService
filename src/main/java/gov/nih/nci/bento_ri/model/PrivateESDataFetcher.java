...
public class PrivateESDataFetcher extends AbstractPrivateESDataFetcher {
    ...
    final Set<String> DIAGNOSIS_REGULAR_PARAMS = Set.of("participant_id", "race", "sex_at_birth", "ethnicity", "phs_accession", "study_acronym", "study_short_title", "diagnosis_classification", "disease_phase", "diagnosis_anatomic_site", "age_at_diagnosis");
    ...
    private List<Map<String, Object>> sampleOverview(Map<String, Object> params) throws IOException {
        final String[][] PROPERTIES = new String[][]{
            ...
            new String[]{"diagnosis_classification", "sample_diagnosis_classification"},
        ...
        Map<String, String> mapping = Map.ofEntries(
                ...
                Map.entry("diagnosis_classification", "sample_diagnosis_classification"),
